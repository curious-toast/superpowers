...
2. Tell Codex:
   ```
   Read and follow instructions from /path/to/superpowers/.codex/INSTALL.md
   ```
...
6. **finishing-a-development-branch** - Activates when tasks complete. Verifies tests, presents options (merge/keep/discard).
...
- **finishing-a-development-branch** - Merge/discard decision workflow
